...
void setup() {
  ...
  if (dataFile) {
    ...
    dataFile.println("Time,Light,T-in,H-in,T-out,H-out,AC%,Sound");
  }
 dataFile.close();
...
File dataFile = SD.open("datalog.txt", FILE_WRITE);
  ...
  if (dataFile) {
    ...
    Serial.print(lux); //Store light on Excel
    Serial.print(","); 

    Serial.print(t1); //Store temperature-inside on Excel
    Serial.print(","); 

    
    Serial.print(h1); //Store humidity-inside on Excel
    Serial.print(","); 

    Serial.print(t2); //Store temperature-outside on Excel
    Serial.print(","); 

    Serial.print(h2); //Store humidity-outside on Excel
    Serial.print(","); 

    Serial.print(ac_percentage); //Store ac percentarge on Excel
    Serial.print(","); 

    Serial.print(db); //Store sound on Excel card
    Serial.print(","); 
